...
```{r echo = FALSE}
boxplot(DFFallecidosCLEAN$EDAD,horizontal = TRUE, main = "Gráfica de cantidad de fallecidos", col = "yellow")
...
```{r, echo=FALSE}
stripchart(DFVacunadosCLEAN$FECHA_VACUNACION,method="overplot",pch=19,bty="n",frame.plot = FALSE,at=y+d,main="GrÃ¡fica de puntos superpuestos con transparencia",ylim = c(0,1),xlab="tiempo de llegada",col=rgb(0,0,0,0.2))
```
