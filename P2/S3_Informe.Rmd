...
## Qué tan probable es que en un día vacunen solo a personas de un sexo (hombre/mujer)
```{r}
Fechas<-table(DFVacunadosCLEAN$FECHA_VACUNACION)
promedio_vacunas_por_dia<-mean(Fechas)
promedio_vacunas_por_dia

prop_hombres<-sum(DFVacunadosCLEAN$SEXO=="MASCULINO")/length(DFVacunadosCLEAN$SEXO)
prop_hombres

prop_mujeres<-sum(DFVacunadosCLEAN$SEXO=="FEMENINO")/length(DFVacunadosCLEAN$SEXO)
prop_mujeres

prop_solo_hombres<-promedio_vacunas_por_dia*prop_hombres
prop_solo_mujeres<-promedio_vacunas_por_dia*prop_mujeres

prop_solo_hombres+prop_solo_mujeres
```
