...
scatter.smooth(DFvac2daOlaLima, main="Cantidad de vacunados en Lima en la 2da Ola", xlab="Fecha de vacunación", ylab="Frecuencia")
scatter.smooth(DFfall2daOlaLima, main="Cantidad de fallecidos en Lima en la 2da Ola", xlab="Fecha de fallecmiento", ylab="Frecuencia")
```
