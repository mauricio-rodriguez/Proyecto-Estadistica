...
```{r}
scatter.smooth(x = DFFallAdulMay2daOla$FECHA_FALLECIMIENTO, y = DFFallAdulMay2daOla$n)
scatter.smooth(x = DFVacAdulMay2daOla$FECHA_VACUNACION, y = DFVacAdulMay2daOla$n)
```
...
```{r}
scatter.smooth(x = DFFallAdul2daOla$FECHA_FALLECIMIENTO, y = DFFallAdul2daOla$n)
scatter.smooth(x = DFVacAdul2daOla$FECHA_VACUNACION, y = DFVacAdul2daOla$n)
```
...
```{r}
scatter.smooth(x = DFFallJov2daOla$FECHA_FALLECIMIENTO, y = DFFallJov2daOla$n)
scatter.smooth(x = DFVacJov2daOla$FECHA_VACUNACION, y = DFVacJov2daOla$n)
```
